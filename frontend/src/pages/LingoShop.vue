  ...
  <LingoLayout>
    <div class="flex w-full flex-col items-center pb-10">
      ...
      <p class="mb-6 text-center text-slate-600">
        {{ t('lingo.shopDescription', 'Spend your points on cool stuff.') }}
      </p>
      ...
      <div class="w-full max-w-md space-y-4 rounded-xl border-2 border-slate-200 bg-white p-4">
        <div class="flex items-center gap-4 border-t-2 border-slate-100 pt-4 first:border-t-0 first:pt-0">
          ...
          <div class="min-w-0 flex-1">
            <p class="font-bold text-slate-700">{{ t('lingo.refillHearts', 'Refill hearts') }}</p>
          </div>
          <span class="text-sm text-slate-500">{{ t('lingo.comingSoon', 'Coming soon') }}</span>
        </div>
        <div class="flex items-center gap-4 border-t-2 border-slate-100 pt-4">
          ...
          <div class="min-w-0 flex-1">
            <p class="font-bold text-slate-700">{{ t('lingo.unlimitedHearts', 'Unlimited hearts') }}</p>
          </div>
          <span class="text-sm text-slate-500">{{ t('lingo.comingSoon', 'Coming soon') }}</span>
        </div>
      </div>
...
useSeoHead({ title: t('lingo.shop', 'Shop') }, locale.value)
</script>
