<template>
  ...
  <div class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div v-if="version.content.gloss_keywords?.length" class="mt-2">
            ...
            <div class="flex flex-wrap gap-2 mt-1">
               <span
                ...
                > {{ keyword.word }} <span v-if="keyword.meaning" class="ml-1 text-blue-600"
          ...
          <div v-if="version.content.place_keywords?.length" class="mt-2">
            ...
            <div class="flex flex-wrap gap-2 mt-1">
               <span
                ...
                > {{ keyword.word }} <span v-if="keyword.meaning" class="ml-1 text-green-600"
                  >({{ keyword.meaning }})</span
                > </span
              >
            </div>
   ...
   <!-- Version Comparison ModalComponent --> <ModalComponent
    :show="showDiffModal"
    ...
    <div class="max-w-4xl">
      ...
      <div v-if="versionDiff" class="space-y-4">
        ...
        >
          ...
          <h4 class="font-medium text-gray-700 mb-2"> {{ formatFieldName(change.field) }} </h4>
