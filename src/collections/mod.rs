...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("collections")
            ...
            .service(controller::get_collection_image)
            ...
            .service(
                web::scope("")
                    ...
                    .service(controller::collections_membership_batch)
                    ...
                    .service(controller::bulk_add_items)
                    ...
                    .service(controller::post_kokoro_tts)
